...
const NewRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage('Error al registrar al usuario: ' + error.message);
      setMessageStyle('error');
  ...
  return (
    <div>
      <div className="container">
        ...
        {errorMessage && <p className={`error-message ${messageStyle}`}>{errorMessage}</p>}
        {successMessage && <p className={`success-message ${messageStyle}`}>{successMessage}</p>}
